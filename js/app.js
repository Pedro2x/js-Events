...
var menuItems = ['Big Mac' ,  'Apple Pie' , 'Fires'];
function valueMenu(){
...
document.getElementById('displayQuotes').innerHTML = quotes[index];
...
var show = document.getElementById("showmoney").style.display == 'none';
...
else{document.getElementById("showmoney").style.display = 'none';
